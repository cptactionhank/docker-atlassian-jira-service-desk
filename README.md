[![Build Status](https://drone-gh.acp.homeoffice.gov.uk/api/badges/UKHomeOffice/docker-jira-service-desk/status.svg)](https://drone-gh.acp.homeoffice.gov.uk/UKHomeOffice/docker-jira-service-desk)
