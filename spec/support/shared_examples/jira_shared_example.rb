...
shared_examples 'an acceptable JIRA Service Desk instance' do |database_examples|
  ...
  describe 'when starting a JIRA Service Desk instance' do
  ...
  describe 'Going through the setup process' do
    ...
    context 'when processing application properties setup' do
      before :all do
        within 'form#jira-setupwizard' do
          fill_in 'title', with: 'JIRA Service Desk Test instance'
    ...
    context 'when processing email notifications setup' do
      ...
      # JIRA Service Desk dashboard without any trouble through the setup.
    end
  end

  describe 'Stopping the JIRA Service Desk instance' do
