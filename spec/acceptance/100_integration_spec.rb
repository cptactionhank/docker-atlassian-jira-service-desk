describe 'Atlassian JIRA Service Desk with Embedded Database' do
...
# describe 'Atlassian JIRA Service Desk with PostgreSQL 9.3 Database' do
#   include_examples 'a buildable Docker image', '.', env: ["CATALINA_OPTS=-Xms1024m -Xmx1024m -XX:+UseG1GC -Datlassian.plugins.enable.wait=#{Docker::DSL.timeout} -Datlassian.darkfeature.jira.onboarding.feature.disabled=true"]
# 
...
# end
# 
# describe 'Atlassian JIRA Service Desk with MySQL 5.6 Database' do
#   include_examples 'a buildable Docker image', '.', env: ["CATALINA_OPTS=-Xms1024m -Xmx1024m -XX:+UseG1GC -Datlassian.plugins.enable.wait=#{Docker::DSL.timeout} -Datlassian.darkfeature.jira.onboarding.feature.disabled=true"]
# 
...
# end
# 
# describe 'Atlassian JIRA Service Desk behind reverse proxy' do
...
#     ]
# 
#   include_examples 'an acceptable JIRA Service Desk instance', 'using an embedded database' do
#     before :all do
